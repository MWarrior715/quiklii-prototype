...
interface CartPageProps {
  onNavigate: (page: Page, data?: NavigationData) => void;
}
    ...
    onNavigate('checkout', {
      items: items.map(item => ({
        ...
        selectedModifiers: item.selectedModifiers.map(mod => ({
          modifierId: Number(mod.modifierId),
          optionId: Number(mod.optionId)
        }))
      })),
      restaurantId: currentRestaurant ? Number(currentRestaurant.id) : undefined,
      total,
      deliveryFee
    });
  };
